...
import { Sparkles, Trophy, Gamepad2, Volume2, VolumeX, LogOut, Flame } from "lucide-react";
          ...
          <div className="flex items-center gap-2.5">
            ...
            {student ? (
              ...
              <div className="flex items-center gap-2.5 bg-emerald-50 border border-emerald-200 rounded-xl p-1.5 pr-3 shadow-xs">
                <Link href="/teacher" className="flex items-center gap-2 hover:opacity-80 transition">
                  ...
                  <div className="text-left leading-tight hidden sm:block">
                    ...
                    <span className="text-[10px] text-emerald-700 font-medium">Cổng Quản Trị →</span>
                  </div>
                </Link>
                <button
                  onClick={() => {
